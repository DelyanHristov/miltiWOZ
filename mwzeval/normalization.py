        ...
        for turn in dialogue:
            ...
            for domain in turn["state"]:
                ...
                for slot, value in turn["state"][domain].items():          
                    ...
                    elif slot == "value_arriveby": slot = "arrive"
...
def normalize_slot_name(slot_name):
    ...
    slot_name_mapping = {
     ...
     'TIME'      : ['booktime','value_booktime', 'value_time', 'time', 'duration', 'value_duration', 'train_duration', 'arriveby','value_arriveby', 'taxi_arriveby', 'value_arriveby', 'arrive by', 'train_arriveby', 'leaveat', 'value_leaveat', 'value_leave', 'leave at', 'train_leaveat', 'train_leave', 'train_arrive', 'taxi_leaveat'],
     ...
     'PRICE'     : ['price', 'value_price', 'entrancefee', 'value_entrancefee', 'entrance fee', 'train_price', 'attraction_entrancefee', 'pricerange', 'value_pricerange', 'price range', 'restaurant_pricerange', 'hotel_pricerange', 'attraction_pricerange', 'attraction_price'],
     'REFERENCE' : ['ref', 'attraction_reference', 'hotel_reference', 'restaurant_reference', 'train_reference', 'value_reference', 'reference'],  
     'COUNT'     : ['stars', 'value_stars', 'hotel_stars', 'bookstay', 'value_bookstay', 'value_stay', 'stay', 'bookpeople','value_bookpeople', 'value_people', 'people', 'choice', 'value_choice', 'value_count', 'attraction_choice', 'hotel_choice', 'restaurant_choice', 'train_choice'],
     'TYPE'      : ['type', 'taxi_type', 'taxi_car', 'value_type', 'value_car', 'car', 'restaurant_type', 'hotel_type', 'attraction_type'],
     'TRAINID'   : ['trainid','value_trainid', 'train_id', 'value_id', 'id', 'train', 'train_trainid'],
...
def normalize_state_slot_value(slot_name, value):
    ...
    elif slot_name in ["arrive", "leave", "arriveby","value_arriveby", "leaveat","value_leaveat", "time"]:
